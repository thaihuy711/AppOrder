...
import com.thaihuy.order.Database.CreateDatabase;
...
public class MonAnDAO {
    ...
    public boolean CapNhatLaiMonAn(int mamon, String tenmon, String gia) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(CreateDatabase.TB_MONAN_TENMONAN, tenmon);
        contentValues.put(CreateDatabase.TB_MONAN_GIATIEN, gia);
